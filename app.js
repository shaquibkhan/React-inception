...
let imageUrl = "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/";
...
// Config Driven UI 
    ...
    const RestaurantCard = ({cloudinaryImageId, name, cuisines, costForTwo, deliveryTime}) => {
      // const {} = restaurant.data;
      return (
         <div className='res-card' style={myStyle}>
            <img className='res-image' src={imageUrl+cloudinaryImageId}></img>
            <h3>{name}</h3>
             <h4>{cuisines.join(", ")}</h4>
